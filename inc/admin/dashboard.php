<?php
function relyo_get_premium_status()
{
...
function relyo_get_theme_initial($name)
{
...
function relyo_get_dashboard_pages_order(): array
{
	$pages_dir = RELYO_DIR . 'inc/admin/pages';
...
$theme_initial = relyo_get_theme_initial($theme_name);

$pages_order = relyo_get_dashboard_pages_order();
...
?>
<div class="dashboard-about-relyo">
	<div class="relyo-about-header">
		<p id="relyo-initial">
			<?php
			printf(
		...
		<p id="relyo-version">
			<?php
			esc_html_e('Version ', 'relyo');
			echo esc_html($theme_version);

			if (relyo_get_premium_status()) :
			?>
				<svg id="relyo-premium-crown" width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
	...
	<div class="relyo-about-body">
		...
		<div id="relyo-content">
			...
			<?php
					...
					echo esc_html__('File does not exist or is not readable.', 'relyo');
				}
			}
			?>
		</div>
